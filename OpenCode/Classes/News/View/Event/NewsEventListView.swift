    ...
    */
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if let d = self.dataArr{
            ...
            (cell as! NewsEventCell).setData(type, dateStr: event["created_at"].string!, userAvatarUrl: event["actor"]["avatar_url"].string!, descText: generateDescriptionStr(type, username: username, repositoryName: reponame))
        }
